...
const SNIPPETS: { text: string; top: string; left: string; rotate: number; size: number }[] = [
    ...
    <div
      ...
      style={{
        ...
        background: withBackground
          ? `radial-gradient(circle at 38% 32%, ${DARK_INK_SOFT} 0%, ${DARK_INK} 72%)`
          : undefined,
        overflow: "hidden",
      }}
    >
      ...
      <div
        ...
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(227,174,184,0.28), rgba(227,174,184,0) 70%)",
        }}
      />
      {RINGS.map((ring, ri) => (
        <div
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              border: "1px dashed rgba(201,143,176,0.32)",
            }}
          />
